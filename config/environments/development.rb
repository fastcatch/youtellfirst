Youtellfirst::Application.configure do
  ...
  config.action_mailer.default_url_options = {
    ...
    :port => Figaro.env.port || 3000,
    :protocol => Figaro.env.protocol || 'http'
  }
...
=begin
  config.action_mailer.smtp_settings = {
    ...
    :enable_starttls_auto => [1, '1', 'true'].include? Figaro.env.smtp_enable_starttls_auto.try(:downcase)
  }
=end
